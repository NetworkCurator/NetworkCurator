...
<html lang="en">
    <head>
        ...
        <script type='text/javascript' src='<?php echo NC_JS_PATH; ?>/jquery-3.1.0.min.js'></script>
        <script type='text/javascript' src='<?php echo NC_JS_PATH; ?>/bootstrap.min.js'></script>
        ...
        <link rel='stylesheet' href='<?php echo NC_CSS_PATH; ?>/bootstrap.min.css'>
