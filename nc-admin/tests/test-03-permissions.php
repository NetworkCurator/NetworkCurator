...
foreach ($users as $uid=>$newperm) {    
    ...
    $params = array('controller' => 'NCUsers', 'action' => 'updatePermissions',
        ...
        'network_name' => 'nc-test-zulu', 'target_id' => $uid, 'permissions' => $newperm);
...
$params = array('controller' => 'NCUsers', 'action' => 'updatePermissions',
        'user_id' => 'admin', 'user_extpwd' => $upw, 'user_ip' => 'install-testdata',
        'network_name' => 'nc-test-xray', 'target_id' => 'bravo', 'permissions' => 4);
tryreport($NCapi, $params, true);
...
$params = array('controller' => 'NCUsers', 'action' => 'updatePermissions',
        'user_id' => 'admin', 'user_extpwd' => $upw, 'user_ip' => 'install-testdata',
        'network_name' => 'nc-test-xray', 'target_id' => 'admin', 'permissions' => 0);
...
$params = array('controller' => 'NCUsers', 'action' => 'updatePermissions',
        'user_id' => 'admin', 'user_extpwd' => $upw, 'user_ip' => 'install-testdata',
        'network_name' => 'nc-test-xray', 'target_id' => 'echo', 'permissions' => 0);
tryreport($NCapi, $params, false);
...
$params = array('controller' => 'NCUsers', 'action' => 'updatePermissions',
        'user_id' => 'admin', 'user_extpwd' => $upw, 'user_ip' => 'install-testdata',
        'network_name' => 'nc-test-update', 'target_id' => 'bravo', 'permissions' => 4);
tryreport($NCapi, $params, false);
