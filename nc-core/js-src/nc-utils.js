...
/* ====================================================================================
 * Developer debuggin functions
 * ==================================================================================== */

nc.utils.consoleNodes = function () {
    console.log("Nodes: "+JSON.stringify(nc.graph.rawnodes) + "\n\n" + 
            JSON.stringify(nc.graph.nodes));
};
nc.utils.consoleLinks = function () {
    console.log("Links: "+JSON.stringify(nc.graph.rawlinks) + "\n\n" + 
            JSON.stringify(nc.graph.links));
};
nc.utils.consoleUser = function () {
    console.log("curate: " + nc.curator + " edit: " + nc.editor + " comment: " + nc.commentator);
    console.log("settings: " + JSON.stringify(nc.graph.settings));
};
nc.utils.consoleOntologies = function () {
    console.log("Ontologies: "+JSON.stringify(nc.ontology.nodes) + "\n\n" + 
            JSON.stringify(nc.ontology.links));
};
